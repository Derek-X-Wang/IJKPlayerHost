...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IJKMediaFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC17IJKMediaFramework11IJKLLPlayer")
@interface IJKLLPlayer : NSObject
...
@interface IJKLLPlayer (SWIFT_EXTENSION(IJKMediaFramework)) <DVGChunkServerDelegate>
- (NSData * _Nullable)requestData:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Nullable)requestData:(NSString * _Nonnull)key dataSent:(NSInteger)offset SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC17IJKMediaFramework12IJKLLSession")
@interface IJKLLSession : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSURLSession;

@interface IJKLLSession (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session didBecomeInvalidWithError:(NSError * _Nullable)error;
@end

@class NSURLSessionDataTask;

@interface IJKLLSession (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionDataDelegate>
...
@interface IJKLLSession (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC17IJKMediaFramework15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(IJKMediaFramework)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC17IJKMediaFramework12TaskDelegate")
